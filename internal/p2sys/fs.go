...
type FS interface {
	...
	// fs.FS. While fs.FS is supported (Adapt), wazy cannot runtime enforce
	...
	Lstat(path string) (Stat_t, Errno)
	...
	// stamps as defined in Stat_t. To retain one or the other, substitute
